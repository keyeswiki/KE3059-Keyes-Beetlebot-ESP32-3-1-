...
请参照链接：[驱动](https://www.keyesrobot.cn/projects/KE3059/zh-cn/latest/docs/3.%20Arduino%20%E6%95%99%E7%A8%8B/3.%20Arduino%20%E6%95%99%E7%A8%8B.html)
...
5\. 选中 <span style="color: rgb(255, 76, 65);">MicroPython库文件</span> 文件夹中的 **ht16k33\.py** 文件，鼠标右键单击 **ht16k33\.py** 文件，然后选择 “**<span style="color: rgb(255, 76, 65);">上传到/</span>**” ，这样，**gfx\.py** 文件被上传到 “**MicroPython device**” 驱动器中。
